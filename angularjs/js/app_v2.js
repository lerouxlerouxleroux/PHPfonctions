...
app.controller('mainCtrl', function($scope, $http) {
    var url_serveur ="http://localhost/projet/php/poo/ajax.php"; // portée générale
...
function getPlayers() {
    var url = url_serveur + "?action=list"; // l'adresse du serveur que l'on souhaite obtenir, http était déclaré plus haut à coté du $scop, copier-coller
